    ...
    <section className="bg-gray-900 rounded-xl border border-gray-800 p-5 space-y-5">
      <div className="flex items-center justify-between gap-3">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-lg font-bold">{t('wl.title')}</h2>
            <p className="text-xs text-gray-500">
              {entries.length} {t('wl.entries_count')}
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="rounded-xl border border-gray-800 bg-gray-950/60 p-4 space-y-3">
        <h3 className="text-sm font-semibold text-gray-300">{t('wl.add_title')}</h3>
        <div className="space-y-3">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-2 bg-blue-600 hover:bg-blue-500 disabled:opacity-50
                       disabled:cursor-not-allowed text-white text-sm font-medium px-4 py-2.5
